...
public class RecorderFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.recorder_view, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recordBtn = view.findViewById(R.id.start_record);
        timer = view.findViewById(R.id.record_timer);
        stopRecord = view.findViewById(R.id.stop_record);
        ...
        switch (v.getId()){
         ...
         //       Log.v("pr","False");
                ...
                if(checkPermission()){
                    ...
                    isRecording = true;
         //           Log.v("isRecording",String.valueOf(isRecording));
    ...
    public boolean checkPermission(){
        if(ActivityCompat.checkSelfPermission(getContext(), Constants.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED){
            return true;
        }else{
            ActivityCompat.requestPermissions(getActivity(), new String[]{Constants.RECORD_AUDIO}, Constants.RECORD_PERMISSION_CODE);
            return false;
        }
    }
    ...
    private void startRecording() {
        ...
        recordedFile = "BlackBoard " + dateFormat.format(current) + ".3gp";
